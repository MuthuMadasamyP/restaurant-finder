...
from source.backend.routes.admin import router as admin_router
from source.backend.routes.auth import router as auth_router
from source.backend.routes.export import router as export_router
from source.backend.routes.feedback import router as feedback_router
from source.backend.routes.search import router as search_router
from source.backend.routes.speech import router as speech_router

from source.backend.services.bootstrap import (
    init_database,
    seed_defaults,
)
